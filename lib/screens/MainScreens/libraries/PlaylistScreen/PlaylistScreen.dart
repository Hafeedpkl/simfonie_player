...
import 'package:simfonie/screens/MainScreens/libraries/PlaylistScreen/playlist_Individual.dart';
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (name.isEmpty) {
                      ...
                      final playlistName =
                          SimfonieModel(name: name, songId: []);
